const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/popover-slots.BACgTdTj.js","assets/chunks/theme.CZfbhyT7.js","assets/chunks/framework.CHy1OJJB.js","assets/chunks/popover-other-status.CVRAAWtD.js","assets/chunks/popover-custom-item.Dwvp9qOs.js","assets/chunks/popover-grouped.Bo0T2Nnb.js","assets/chunks/popover-trigger.DD-vKEmK.js","assets/chunks/popover-basic.DKdAGZQH.js"])))=>i.map(i=>d[i]);
import{s as r,A as c,_ as u,r as w,H as Z,e as P,o as X,a4 as _,ah as p,J as e,q as o,ai as g,x as n,i,ak as m,g as s}from"./chunks/framework.CHy1OJJB.js";import{L as h,N as b}from"./chunks/index.BOmotwSW.js";const S=`<template>
...
<\/script>
`,E=JSON.parse('{"title":"SuggestionPopover 建议弹出框","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"components/suggestion-popover.md","filePath":"components/suggestion-popover.md"}'),L={name:"components/suggestion-popover.md"},V=Object.assign(L,{setup(C){const v=r();c(async()=>{v.value=(await u(async()=>{const{default:a}=await import("./chunks/popover-slots.BACgTdTj.js");return{default:a}},__vite__mapDeps([0,1,2]))).default});const y=r();c(async()=>{y.value=(await u(async()=>{const{default:a}=await import("./chunks/popover-other-status.CVRAAWtD.js");return{default:a}},__vite__mapDeps([3,1,2]))).default});const f=r();c(async()=>{f.value=(await u(async()=>{const{default:a}=await import("./chunks/popover-custom-item.Dwvp9qOs.js");return{default:a}},__vite__mapDeps([4,1,2]))).default});const k=r();c(async()=>{k.value=(await u(async()=>{const{default:a}=await import("./chunks/popover-grouped.Bo0T2Nnb.js");return{default:a}},__vite__mapDeps([5,1,2]))).default});const x=r();c(async()=>{x.value=(await u(async()=>{const{default:a}=await import("./chunks/popover-trigger.DD-vKEmK.js");return{default:a}},__vite__mapDeps([6,1,2]))).default});const d=w(!0),W=r();return c(async()=>{W.value=(await u(async()=>{const{default:a}=await import("./chunks/popover-basic.DKdAGZQH.js");return{default:a}},__vite__mapDeps([7,1,2]))).default}),(a,t)=>{const l=Z("ClientOnly");return X(),P("div",null,[t[6]||(t[6]=_('<h1 id="suggestionpopover-建议弹出框" tabindex="-1">SuggestionPopover 建议弹出框 <a class="header-anchor" href="#suggestionpopover-建议弹出框" aria-label="Permalink to &quot;SuggestionPopover 建议弹出框&quot;">​</a></h1><h2 id="代码示例" tabindex="-1">代码示例 <a class="header-anchor" href="#代码示例" aria-label="Permalink to &quot;代码示例&quot;">​</a></h2><h3 id="基本示例" tabindex="-1">基本示例 <a class="header-anchor" href="#基本示例" aria-label="Permalink to &quot;基本示例&quot;">​</a></h3><p>使用 <code>data</code> 传入数据，</p>',4)),p(e(n(h),null,null,512),[[g,d.value]]),e(l,null,{default:i(()=>[e(n(b),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[0]||(t[0]=()=>{d.value=!1}),vueCode:n(T)},m({_:2},[W.value?{name:"vue",fn:i(()=>[e(n(W))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[7]||(t[7]=_('<h3 id="触发方式" tabindex="-1">触发方式 <a class="header-anchor" href="#触发方式" aria-label="Permalink to &quot;触发方式&quot;">​</a></h3><p>使用 <code>trggier</code> 来决定弹出框的触发方式。目前有 <code>click</code> 和 <code>manual</code> 两种方式，默认为 <code>click</code>。<code>trggier</code> 为 <code>manual</code> 时，需要你手动修改弹出框显示状态</p>',2)),p(e(n(h),null,null,512),[[g,d.value]]),e(l,null,{default:i(()=>[e(n(b),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[1]||(t[1]=()=>{d.value=!1}),vueCode:n(A)},m({_:2},[x.value?{name:"vue",fn:i(()=>[e(n(x))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[8]||(t[8]=o("h3",{id:"分组数据",tabindex:"-1"},[s("分组数据 "),o("a",{class:"header-anchor",href:"#分组数据","aria-label":'Permalink to "分组数据"'},"​")],-1)),t[9]||(t[9]=o("p",null,[o("code",null,"data"),s(" 数组中的项，添加 "),o("code",null,"group"),s(" 字段来表示为分组数据。分组数据和普通数据不能混合")],-1)),p(e(n(h),null,null,512),[[g,d.value]]),e(l,null,{default:i(()=>[e(n(b),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[2]||(t[2]=()=>{d.value=!1}),vueCode:n(I)},m({_:2},[k.value?{name:"vue",fn:i(()=>[e(n(k))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[10]||(t[10]=o("h3",{id:"自定义渲染列表项",tabindex:"-1"},[s("自定义渲染列表项 "),o("a",{class:"header-anchor",href:"#自定义渲染列表项","aria-label":'Permalink to "自定义渲染列表项"'},"​")],-1)),t[11]||(t[11]=o("p",null,[s("使用 "),o("code",null,"item"),s(" 插槽自定义渲染列表项")],-1)),p(e(n(h),null,null,512),[[g,d.value]]),e(l,null,{default:i(()=>[e(n(b),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[3]||(t[3]=()=>{d.value=!1}),vueCode:n(D)},m({_:2},[f.value?{name:"vue",fn:i(()=>[e(n(f))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[12]||(t[12]=o("h3",{id:"加载中和空数据",tabindex:"-1"},[s("加载中和空数据 "),o("a",{class:"header-anchor",href:"#加载中和空数据","aria-label":'Permalink to "加载中和空数据"'},"​")],-1)),p(e(n(h),null,null,512),[[g,d.value]]),e(l,null,{default:i(()=>[e(n(b),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[4]||(t[4]=()=>{d.value=!1}),vueCode:n(B)},m({_:2},[y.value?{name:"vue",fn:i(()=>[e(n(y))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[13]||(t[13]=o("h3",{id:"其他插槽",tabindex:"-1"},[s("其他插槽 "),o("a",{class:"header-anchor",href:"#其他插槽","aria-label":'Permalink to "其他插槽"'},"​")],-1)),t[14]||(t[14]=o("p",null,[s("另外还提供了 "),o("code",null,"header"),s(" 和 "),o("code",null,"body"),s(" 插槽，方便开发者扩展")],-1)),p(e(n(h),null,null,512),[[g,d.value]]),e(l,null,{default:i(()=>[e(n(b),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[5]||(t[5]=()=>{d.value=!1}),vueCode:n(S)},m({_:2},[v.value?{name:"vue",fn:i(()=>[e(n(v))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[15]||(t[15]=_(`<h3 id="移动端适配" tabindex="-1">移动端适配 <a class="header-anchor" href="#移动端适配" aria-label="Permalink to &quot;移动端适配&quot;">​</a></h3><blockquote><p>目前移动端判断逻辑是，视窗宽度小于 768px</p></blockquote><p>将窗口宽度缩小到 768px，可以点击查看上面的示例</p><h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-label="Permalink to &quot;API&quot;">​</a></h2><h3 id="props" tabindex="-1">Props <a class="header-anchor" href="#props" aria-label="Permalink to &quot;Props&quot;">​</a></h3><p>弹出框属性配置。</p><table tabindex="0"><thead><tr><th>属性</th><th>类型</th><th>默认值</th><th>说明</th></tr></thead><tbody><tr><td><code>data</code></td><td><code>SuggestionData</code></td><td>-</td><td><strong>必填</strong>，建议数据</td></tr><tr><td><code>title</code></td><td><code>string</code></td><td>-</td><td>弹出框标题</td></tr><tr><td><code>icon</code></td><td><code>VNode | Component</code></td><td>-</td><td>标题图标</td></tr><tr><td><code>show</code></td><td><code>boolean</code></td><td>-</td><td>控制弹出框显示/隐藏，仅在 trigger 为 &#39;manual&#39; 时有效</td></tr><tr><td><code>trigger</code></td><td><code>&#39;click&#39; | &#39;manual&#39;</code></td><td><code>&#39;click&#39;</code></td><td>触发方式：点击或手动控制</td></tr><tr><td><code>selectedGroup</code></td><td><code>string</code></td><td>-</td><td>当前选中分组 (v-model)</td></tr><tr><td><code>groupShowMoreTrigger</code></td><td><code>&#39;click&#39; | &#39;hover&#39;</code></td><td>-</td><td>分组&quot;显示更多&quot;的触发方式</td></tr><tr><td><code>loading</code></td><td><code>boolean</code></td><td><code>false</code></td><td>是否显示加载状态</td></tr><tr><td><code>topOffset</code></td><td><code>number</code></td><td>-</td><td>顶部偏移量</td></tr></tbody></table><h3 id="slots" tabindex="-1">Slots <a class="header-anchor" href="#slots" aria-label="Permalink to &quot;Slots&quot;">​</a></h3><p>弹出框插槽定义。</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>+---------------------------+         +-----------+</span></span>

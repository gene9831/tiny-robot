const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Stream.mp1Rebli.js","assets/chunks/theme.gnhZ_qos.js","assets/chunks/framework.aRpsRkr5.js","assets/chunks/index.ITwCmkWu.js","assets/chunks/Basic.DJJJpOUr.js"])))=>i.map(i=>d[i]);
import{s as r,A as o,_ as d,r as F,H as D,e as m,o as C,a4 as y,ah as g,J as i,q as n,ai as c,x as a,i as l,ak as A,g as b}from"./chunks/framework.aRpsRkr5.js";import{M as E,B as u}from"./chunks/index.C8D5MZ65.js";const f=`<script setup lang="ts">
...
`,w=JSON.parse('{"title":"AI模型交互工具类 AIClient","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"tools/ai-client.md","filePath":"tools/ai-client.md"}'),v={name:"tools/ai-client.md"},S=Object.assign(v,{setup(_){const h=r();o(async()=>{h.value=(await d(async()=>{const{default:e}=await import("./chunks/Stream.mp1Rebli.js");return{default:e}},__vite__mapDeps([0,1,2,3]))).default});const t=F(!0),p=r();return o(async()=>{p.value=(await d(async()=>{const{default:e}=await import("./chunks/Basic.DJJJpOUr.js");return{default:e}},__vite__mapDeps([4,1,2,3]))).default}),(e,s)=>{const k=D("ClientOnly");return C(),m("div",null,[s[2]||(s[2]=y('<h1 id="ai模型交互工具类-aiclient" tabindex="-1">AI模型交互工具类 AIClient <a class="header-anchor" href="#ai模型交互工具类-aiclient" aria-label="Permalink to &quot;AI模型交互工具类 AIClient&quot;">​</a></h1><p>客户端类，用于与AI模型交互。</p><h2 id="用法示例" tabindex="-1">用法示例 <a class="header-anchor" href="#用法示例" aria-label="Permalink to &quot;用法示例&quot;">​</a></h2><h3 id="创建客户端并发送消息" tabindex="-1">创建客户端并发送消息 <a class="header-anchor" href="#创建客户端并发送消息" aria-label="Permalink to &quot;创建客户端并发送消息&quot;">​</a></h3>',4)),g(i(a(E),null,null,512),[[c,t.value]]),i(k,null,{default:l(()=>[i(a(u),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{t.value=!1}),vueCode:a(B)},A({_:2},[p.value?{name:"vue",fn:l(()=>[i(a(p))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),s[3]||(s[3]=n("h3",{id:"使用流式响应",tabindex:"-1"},[b("使用流式响应 "),n("a",{class:"header-anchor",href:"#使用流式响应","aria-label":'Permalink to "使用流式响应"'},"​")],-1)),s[4]||(s[4]=n("ul",null,[n("li",null,"使用chatStream方法实现流式响应"),n("li",null,"signal参数传递 AbortController用于中断请求")],-1)),g(i(a(E),null,null,512),[[c,t.value]]),i(k,null,{default:l(()=>[i(a(u),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[1]||(s[1]=()=>{t.value=!1}),vueCode:a(f)},A({_:2},[h.value?{name:"vue",fn:l(()=>[i(a(h))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),s[5]||(s[5]=y(`<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-label="Permalink to &quot;API&quot;">​</a></h2><h3 id="构造函数" tabindex="-1">构造函数 <a class="header-anchor" href="#构造函数" aria-label="Permalink to &quot;构造函数&quot;">​</a></h3><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> client</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">AIClient</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> AIClient</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(config: AIModelConfig)</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div>`,5))])}}});export{w as __pageData,S as default};

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/responsive-layout.B2tqYzzL.js","assets/chunks/theme.CSQSN5UK.js","assets/chunks/framework.BxUN6Jop.js","assets/chunks/card-and-grid.DHeskeUf.js","assets/chunks/manager-slots.BmLiVZRq.js","assets/chunks/controlled-events.KJJYd7Nh.js","assets/chunks/empty-states.CmEeuGOf.js","assets/chunks/progress.CpWsXEGn.js","assets/chunks/browse-and-filter.CCZkKBhI.js","assets/chunks/basic.DKXxgIVf.js"])))=>i.map(i=>d[i]);
import{aD as o,bQ as l,aZ as B,aL as D,v as _,H as r,bL as c,bB as h,J as e,bk as i,bJ as s,G as p,w as u,I as b,b7 as k,aU as T}from"./chunks/framework.BxUN6Jop.js";import{L as y,N as g}from"./chunks/index.DtYzv2Q1.js";const w=`<script setup lang="ts">
import { ref } from 'vue'
...
`,V=JSON.parse('{"title":"ExtensionManager 扩展管理组件","description":"","frontmatter":{"outline":[1,3],"pageClass":"demo-container-page-bg"},"headers":[],"relativePath":"components/extension-manager.md","filePath":"components/extension-manager.md"}'),Z={name:"components/extension-manager.md"},N=Object.assign(Z,{setup(X){const E=k();o(async()=>{E.value=(await l(async()=>{const{default:n}=await import("./chunks/responsive-layout.B2tqYzzL.js");return{default:n}},__vite__mapDeps([0,1,2]))).default});const m=k();o(async()=>{m.value=(await l(async()=>{const{default:n}=await import("./chunks/card-and-grid.DHeskeUf.js");return{default:n}},__vite__mapDeps([3,1,2]))).default});const F=k();o(async()=>{F.value=(await l(async()=>{const{default:n}=await import("./chunks/manager-slots.BmLiVZRq.js");return{default:n}},__vite__mapDeps([4,1,2]))).default});const C=k();o(async()=>{C.value=(await l(async()=>{const{default:n}=await import("./chunks/controlled-events.KJJYd7Nh.js");return{default:n}},__vite__mapDeps([5,1,2]))).default});const A=k();o(async()=>{A.value=(await l(async()=>{const{default:n}=await import("./chunks/empty-states.CmEeuGOf.js");return{default:n}},__vite__mapDeps([6,1,2]))).default});const x=k();o(async()=>{x.value=(await l(async()=>{const{default:n}=await import("./chunks/progress.CpWsXEGn.js");return{default:n}},__vite__mapDeps([7,1,2]))).default});const v=k();o(async()=>{v.value=(await l(async()=>{const{default:n}=await import("./chunks/browse-and-filter.CCZkKBhI.js");return{default:n}},__vite__mapDeps([8,1,2]))).default});const a=T(!0),f=k();return o(async()=>{f.value=(await l(async()=>{const{default:n}=await import("./chunks/basic.DKXxgIVf.js");return{default:n}},__vite__mapDeps([9,1,2]))).default}),(n,t)=>{const d=B("ClientOnly");return D(),_("div",null,[t[8]||(t[8]=r('<h1 id="extensionmanager-扩展管理组件" tabindex="-1">ExtensionManager 扩展管理组件 <a class="header-anchor" href="#extensionmanager-扩展管理组件" aria-label="Permalink to &quot;ExtensionManager 扩展管理组件&quot;">​</a></h1><p><code>ExtensionManager</code> 用于浏览和管理通用 Extension。组件提供标签页切换、筛选、自动分区和分区展开，并自行维护筛选与分区展开状态。当前标签页既可以由父组件控制，也可以由组件维护。安装、卸载、开关状态和详情跳转等操作会触发事件，由应用决定如何更新 Extension 数据或打开后续界面。</p><h2 id="概览" tabindex="-1">概览 <a class="header-anchor" href="#概览" aria-label="Permalink to &quot;概览&quot;">​</a></h2><h3 id="适用场景" tabindex="-1">适用场景 <a class="header-anchor" href="#适用场景" aria-label="Permalink to &quot;适用场景&quot;">​</a></h3><ul><li>在一个面板中按标签页浏览 Extension，并按标签和关键词过滤。</li><li>为已安装和可安装的 Extension 提供一致的卡片、操作和进度反馈。</li><li>在应用页面、Modal 或 Drawer 中嵌入管理内容。组件本身不控制容器的显示、焦点和滚动。</li></ul><h3 id="选择建议" tabindex="-1">选择建议 <a class="header-anchor" href="#选择建议" aria-label="Permalink to &quot;选择建议&quot;">​</a></h3><p>需要让用户在同一处浏览、筛选和管理多类扩展时，使用 <code>ExtensionManager</code>。它展示列表并报告用户操作；添加 MCP、导入 Skill 和查看详情可交给对应的<a href="./mcp-extension.html">专用 MCP 组件</a>或 <a href="./skill-extension.html">Skill 组件</a>。应用负责加载和保存数据，以及打开和关闭这些界面。完整组合流程见 <a href="/tiny-robot/alpha/best-practices/extension-manager-integration.html">MCP 与 Skill 扩展管理实践</a>。</p><h2 id="用法示例" tabindex="-1">用法示例 <a class="header-anchor" href="#用法示例" aria-label="Permalink to &quot;用法示例&quot;">​</a></h2><p>下面以 MCP 和 Skills 两类 Extension 为例，展示一个可直接运行的管理场景。MCP 已安装，支持启用开关，并可从更多操作中卸载；Skills 可以安装，安装后会移动到“已安装”分区。卸载 MCP 后，条目会回到“可安装”分区，并可重新安装。</p>',9)),c(e(i(y),null,null,512),[[h,a.value]]),e(d,null,{default:s(()=>[e(i(g),{title:"管理 MCP 与 Skills",description:"切换 MCP 开关、安装 Skills，或卸载并重新安装 MCP，观察条目在分区之间移动。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[0]||(t[0]=()=>{a.value=!1}),vueCode:i(I)},p({_:2},[f.value?{name:"vue",fn:s(()=>[e(i(f))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[9]||(t[9]=r('<h2 id="浏览、筛选和自动分区" tabindex="-1">浏览、筛选和自动分区 <a class="header-anchor" href="#浏览、筛选和自动分区" aria-label="Permalink to &quot;浏览、筛选和自动分区&quot;">​</a></h2><p>组件会读取当前标签页中各条目的 <code>tags</code>，生成标签筛选选项。当前标签页没有可用标签时，组件隐藏标签筛选器，但仍显示关键词搜索。</p><p>搜索会忽略首尾空白，并匹配 <code>name</code> 和 <code>description</code>。同时设置标签和关键词时，条目需要同时满足两个条件。每个标签页保存自己的筛选条件。已选择的标签不再存在时，组件会清除该标签条件。</p><p><code>installed: true</code> 的条目归入“已安装”；<code>installed: false</code> 或省略 <code>installed</code> 的条目归入“可安装”。两段始终显示，即使筛选后没有条目；原始数据的顺序会保留。</p>',4)),c(e(i(y),null,null,512),[[h,a.value]]),e(d,null,{default:s(()=>[e(i(g),{title:"浏览、筛选与自动分区",description:"切换标签页、选择标签或输入关键词，观察筛选后的已安装和可安装分区。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[1]||(t[1]=()=>{a.value=!1}),vueCode:i(G)},p({_:2},[v.value?{name:"vue",fn:s(()=>[e(i(v))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[10]||(t[10]=r('<h2 id="状态与反馈" tabindex="-1">状态与反馈 <a class="header-anchor" href="#状态与反馈" aria-label="Permalink to &quot;状态与反馈&quot;">​</a></h2><h3 id="进度" tabindex="-1">进度 <a class="header-anchor" href="#进度" aria-label="Permalink to &quot;进度&quot;">​</a></h3><p>Card 的 <code>progress</code> 可以是 <code>0</code> 至 <code>100</code> 的数值，超出范围会被限制；使用 <code>&#39;indeterminate&#39;</code> 表示不确定进度。</p>',3)),c(e(i(y),null,null,512),[[h,a.value]]),e(d,null,{default:s(()=>[e(i(g),{title:"卡片进度",description:"分别展示确定进度、不确定进度和超出范围数值的限制结果。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[2]||(t[2]=()=>{a.value=!1}),vueCode:i(S)},p({_:2},[x.value?{name:"vue",fn:s(()=>[e(i(x))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[11]||(t[11]=u("h3",{id:"空状态",tabindex:"-1"},[b("空状态 "),u("a",{class:"header-anchor",href:"#空状态","aria-label":'Permalink to "空状态"'},"​")],-1)),t[12]||(t[12]=u("p",null,[b("每个当前标签页都有“已安装”和“可安装”两个可折叠分区。搜索或标签筛选后没有匹配项时，分区显示空状态，筛选控件仍可用于恢复结果。当前标签页原本就没有条目时，也显示空分区；此时标签筛选器隐藏，搜索框仍会显示。"),u("code",null,"empty"),b(" 插槽接收分区标题。没有可显示的标签页时只显示 "),u("code",null,"empty-text"),b("，不显示筛选控件和分区。")],-1)),c(e(i(y),null,null,512),[[h,a.value]]),e(d,null,{default:s(()=>[e(i(g),{title:"分区与管理器空状态",description:"分别定制空分区内容，并为没有标签页的管理器提供提示文字。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[3]||(t[3]=()=>{a.value=!1}),vueCode:i(q)},p({_:2},[A.value?{name:"vue",fn:s(()=>[e(i(A))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[13]||(t[13]=r('<h2 id="交互与状态管理" tabindex="-1">交互与状态管理 <a class="header-anchor" href="#交互与状态管理" aria-label="Permalink to &quot;交互与状态管理&quot;">​</a></h2><h3 id="状态所有权" tabindex="-1">状态所有权 <a class="header-anchor" href="#状态所有权" aria-label="Permalink to &quot;状态所有权&quot;">​</a></h3><p><code>ExtensionManager</code> 同时处理外部数据、可由父组件控制的值，以及组件自身的界面状态。接入时需要先明确每项数据由谁更新。用户点击“安装”、切换开关或点击名称时，组件不会直接修改 <code>tabs</code> 或条目数据。</p><table tabindex="0"><thead><tr><th>状态 / 数据</th><th>管理方</th><th>更新方式</th></tr></thead><tbody><tr><td>Extension 数据</td><td>应用</td><td>处理 <code>action</code> 后更新 <code>tabs</code></td></tr><tr><td>当前标签页（受控）</td><td>应用</td><td>处理 <code>update:active-tab</code> 后更新绑定值</td></tr><tr><td>当前标签页（非受控）</td><td>组件</td><td>自动更新内部状态</td></tr><tr><td>标签筛选和搜索词</td><td>组件</td><td>按标签页分别保存筛选条件</td></tr><tr><td>分区展开状态</td><td>组件</td><td>先更新内部状态，再触发 <code>section-toggle</code></td></tr></tbody></table><h3 id="当前标签页" tabindex="-1">当前标签页 <a class="header-anchor" href="#当前标签页" aria-label="Permalink to &quot;当前标签页&quot;">​</a></h3><p>当前标签页同时支持受控和非受控两种使用方式：</p><ul><li><strong>受控方式</strong><ul><li>当前值来自 <code>active-tab</code>，<code>default-active-tab</code> 不生效。</li><li>用户选择标签页时，组件依次触发 <code>update:active-tab</code> 和 <code>tab-change</code>；父组件需要更新 <code>active-tab</code>。</li><li><code>active-tab</code> 无效时，组件显示第一个可用标签页并触发 <code>update:active-tab</code>。没有标签页时参数为 <code>undefined</code>。这两种情况都不会触发 <code>tab-change</code>。</li></ul></li><li><strong>非受控方式</strong><ul><li>当前值由组件保存，初始值来自 <code>default-active-tab</code>；未提供或无效时使用第一个标签页。</li><li>用户选择标签页时，组件先更新内部状态，再依次触发 <code>update:active-tab</code> 和 <code>tab-change</code>。</li><li><code>tabs</code> 变化导致当前值失效时，组件自动切换到新的第一个标签页并触发 <code>update:active-tab</code>，不触发 <code>tab-change</code>。</li></ul></li></ul><p>非受控模式初始化时，即使 <code>default-active-tab</code> 无效并改用第一个标签页，也不会额外触发 <code>update:active-tab</code>。父组件直接修改受控的 <code>active-tab</code> 也不会触发 <code>tab-change</code>，因为 <code>tab-change</code> 只表示用户选择了标签页。</p>',8)),c(e(i(y),null,null,512),[[h,a.value]]),e(d,null,{default:s(()=>[e(i(g),{title:"由父组件控制当前标签页",description:"使用 v-model:active-tab 保存当前标签页，并显示父组件收到的最新值。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[4]||(t[4]=()=>{a.value=!1}),vueCode:i(P)},p({_:2},[C.value?{name:"vue",fn:s(()=>[e(i(C))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[14]||(t[14]=r('<h3 id="处理操作事件" tabindex="-1">处理操作事件 <a class="header-anchor" href="#处理操作事件" aria-label="Permalink to &quot;处理操作事件&quot;">​</a></h3><p>快速开始中的 MCP 开关与卸载操作，以及 Skills 安装按钮，展示了应用如何根据 <code>action</code> 更新数据。<code>action</code> 和 <code>name-click</code> 只说明用户执行了什么操作，不表示组件已经修改 <code>tabs</code>。例如，switch action 的 <code>action.checked</code> 是用户选择的新状态。Card 仍会显示传入的 <code>checked</code>，因此应用需要更新对应 action。用户点击安装或卸载按钮时，组件同样只触发事件。操作完成后，应用需要更新 <code>item.installed</code> 和对应 <code>actions</code>，组件随后会按照新的 <code>tabs</code> 重新分区。</p><p>分区展开状态按标签页和分区分别保存。组件会先更新展开状态，再触发 <code>section-toggle</code>。事件中的 <code>expanded</code> 是更新后的值，应用不需要再同步这个状态，可以按需监听该事件。</p><p>需要把列表事件、MCP/Skill 添加与详情界面、kit 存储接成一个流程时，参见<a href="/tiny-robot/alpha/best-practices/extension-manager-integration.html">MCP 与 Skill 扩展管理实践</a>。</p><h2 id="组合与定制" tabindex="-1">组合与定制 <a class="header-anchor" href="#组合与定制" aria-label="Permalink to &quot;组合与定制&quot;">​</a></h2><h3 id="定制-extensionmanager-区域" tabindex="-1">定制 ExtensionManager 区域 <a class="header-anchor" href="#定制-extensionmanager-区域" aria-label="Permalink to &quot;定制 ExtensionManager 区域&quot;">​</a></h3><p><code>header-actions</code>、<code>tab</code>、<code>item</code> 和 <code>empty</code> 分别用于定制头部操作区、标签内容、条目和空状态。定制 <code>tab</code> 时，建议调用作用域中的 <code>select()</code> 选择标签页，不要依赖内部 DOM。</p><p><code>item</code> 插槽会替换默认 Card。<code>ExtensionManager</code> 仍负责外层列表和条目顺序，并使用 <code>item.id</code> 标识条目，但不再提供默认 Card 的 <code>action</code>、<code>name-click</code>、键盘交互和 ARIA 语义。如果自定义条目需要这些功能，开发者需要在插槽内自行实现。插槽中的 <code>item</code> 是 <code>ExtensionCardGridItem</code>，不包含 <code>ExtensionManager</code> 使用的 <code>installed</code> 和 <code>tags</code>。</p>',8)),c(e(i(y),null,null,512),[[h,a.value]]),e(d,null,{default:s(()=>[e(i(g),{title:"替换管理器区域",description:"在不依赖内部 DOM 的前提下定制头部、标签、条目和空分区。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[5]||(t[5]=()=>{a.value=!1}),vueCode:i(W)},p({_:2},[F.value?{name:"vue",fn:s(()=>[e(i(F))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[15]||(t[15]=r('<h3 id="独立组合-card-与-cardgrid" tabindex="-1">独立组合 Card 与 CardGrid <a class="header-anchor" href="#独立组合-card-与-cardgrid" aria-label="Permalink to &quot;独立组合 Card 与 CardGrid&quot;">​</a></h3><p><code>ExtensionManager.Card</code> 和 <code>ExtensionManager.CardGrid</code> 可以独立使用，也分别以 <code>TrExtensionCard</code> 和 <code>TrExtensionCardGrid</code> 导出。Card 直接接收 <code>name</code>、<code>description</code> 和 <code>actions</code> 等 Prop，不接收 <code>item</code> Prop。CardGrid 则接收带有稳定 <code>id</code> 的条目数组。</p><p>Card 会先过滤 <code>hidden: true</code> 的 action，再按数组顺序和 <code>primary-actions-limit</code> 划分主操作与更多操作。<code>disabled</code> action 不会被过滤，仍会占据原来的位置，但用户无法触发它。</p><p><code>primary-action</code> 插槽只会处理位于主操作区域的 custom action。调用 <code>trigger(payload)</code> 后，Card 会触发标准 <code>action</code> 事件，并将参数放入 <code>event.payload</code>。<code>action.data</code> 是 action 自身的数据，不会自动复制到 <code>event.payload</code>。没有提供插槽时，custom action 会显示为普通按钮；进入更多操作菜单的 custom action 也使用默认菜单项。</p>',4)),c(e(i(y),null,null,512),[[h,a.value]]),e(d,null,{default:s(()=>[e(i(g),{title:"独立使用 Card 与 CardGrid",description:"在独立 Card 中定制主操作并展示更多操作，同时使用 CardGrid 的 item 插槽替换条目内容。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[6]||(t[6]=()=>{a.value=!1}),vueCode:i(M)},p({_:2},[m.value?{name:"vue",fn:s(()=>[e(i(m))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[16]||(t[16]=r('<h2 id="可访问性与设计约束" tabindex="-1">可访问性与设计约束 <a class="header-anchor" href="#可访问性与设计约束" aria-label="Permalink to &quot;可访问性与设计约束&quot;">​</a></h2><h3 id="键盘与焦点" tabindex="-1">键盘与焦点 <a class="header-anchor" href="#键盘与焦点" aria-label="Permalink to &quot;键盘与焦点&quot;">​</a></h3><p>标签页使用原生按钮和 tab 语义。焦点位于标签页时，使用 <code>ArrowLeft</code>、<code>ArrowRight</code> 循环选择并聚焦相邻标签页，使用 <code>Home</code> 或 <code>End</code> 跳到首个或末个标签页；<code>Enter</code> 和 <code>Space</code> 也可以激活标签页。</p><p>Card 名称默认可以点击，并支持 <code>Enter</code> 和 <code>Space</code>。设置 <code>name-clickable=&quot;false&quot;</code> 后，名称显示为普通文本，不再进入 Tab 顺序。分区标题、switch、更多操作按钮、筛选控件和清空搜索按钮均保留对应原生控件的键盘行为。系统启用“减少动态效果”后，活动标签指示条不再播放过渡动画。</p><h3 id="响应式与长内容" tabindex="-1">响应式与长内容 <a class="header-anchor" href="#响应式与长内容" aria-label="Permalink to &quot;响应式与长内容&quot;">​</a></h3><p>筛选区域根据 <code>ExtensionManager</code> 自身的容器宽度调整布局，不依赖浏览器视口宽度。存在标签筛选器且容器宽度不超过 <code>480px</code> 时，标签选择和搜索框由两列变为单列；没有可用标签时，搜索框始终独占一行。</p><p>CardGrid 根据自身容器宽度自动调整列数。每列默认至少为 <code>320px</code>，可以通过 <code>--tr-extension-card-grid-card-min-width</code> 调整。Card 名称和描述过长时会在单行内省略，完整内容保留在 <code>title</code> 中。</p>',7)),c(e(i(y),null,null,512),[[h,a.value]]),e(d,null,{default:s(()=>[e(i(g),{title:"容器响应式布局",description:"切换宽窄容器，观察筛选控件和 CardGrid 如何根据组件容器宽度调整布局。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[7]||(t[7]=()=>{a.value=!1}),vueCode:i(w)},p({_:2},[E.value?{name:"vue",fn:s(()=>[e(i(E))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[17]||(t[17]=r(`<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-label="Permalink to &quot;API&quot;">​</a></h2><p>以下组件和类型均从 <code>@opentiny/tiny-robot</code> 导出：</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { TrExtensionCard, TrExtensionCardGrid, TrExtensionManager } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@opentiny/tiny-robot&#39;</span></span>

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/state-change.Bxfn0Bdv.js","assets/chunks/framework.D5IXmigW.js","assets/chunks/theme.DhLI3jyC.js","assets/chunks/custom-renderer.C09JInfY.js","assets/chunks/tools.GDxRp8kT.js","assets/chunks/reasoning.DGgO2iYq.js","assets/chunks/provider-renderer.Ds6ktNsn.js","assets/chunks/list-auto-scroll.CCRgzk2q.js","assets/chunks/list-hidden.DaTLJUMy.js","assets/chunks/list-array-content.D_KLLQH2.js","assets/chunks/list-custom-group.Cwq0mi5J.js","assets/chunks/list-consecutive.BAHq6Neb.js","assets/chunks/list.BgbA9NvW.js","assets/chunks/schema-render.C0QskAOK.js","assets/chunks/slots.B3yUMQjN.js","assets/chunks/content-resolver.BXC4_gzE.js","assets/chunks/content-render-mode.otaIJbIz.js","assets/chunks/image.B5rTk0Kn.js","assets/chunks/streaming.oUeugR_G.js","assets/chunks/markdown.pftMmKju.js","assets/chunks/loading.DhxNHwRt.js","assets/chunks/shape.CbeBgevW.js","assets/chunks/avatar-and-placement.DkL-Nb6x.js","assets/chunks/basic.BrmWc2z_.js"])))=>i.map(i=>d[i]);
import{aD as k,bQ as u,aZ as q,aL as J,v as V,H as y,bL as d,bB as r,J as t,bk as s,bJ as i,G as p,w as l,I as b,b7 as g,aU as z}from"./chunks/framework.D5IXmigW.js";import{L as h,N as c}from"./chunks/index.BPwzYTgQ.js";const U=`<template>
...
import { TrBubble } from '@opentiny/tiny-robot'
<\/script>
`,ge=JSON.parse('{"title":"Bubble 气泡组件","description":"","frontmatter":{"outline":[1,3]},"headers":[],"relativePath":"components/bubble.md","filePath":"components/bubble.md"}'),ce={name:"components/bubble.md"},ye=Object.assign(ce,{setup(ke){const E=g();k(async()=>{E.value=(await u(async()=>{const{default:a}=await import("./chunks/state-change.Bxfn0Bdv.js");return{default:a}},__vite__mapDeps([0,1,2]))).default});const v=g();k(async()=>{v.value=(await u(async()=>{const{default:a}=await import("./chunks/custom-renderer.C09JInfY.js");return{default:a}},__vite__mapDeps([3,2,1]))).default});const C=g();k(async()=>{C.value=(await u(async()=>{const{default:a}=await import("./chunks/tools.GDxRp8kT.js");return{default:a}},__vite__mapDeps([4,1,2]))).default});const f=g();k(async()=>{f.value=(await u(async()=>{const{default:a}=await import("./chunks/reasoning.DGgO2iYq.js");return{default:a}},__vite__mapDeps([5,1,2]))).default});const m=g();k(async()=>{m.value=(await u(async()=>{const{default:a}=await import("./chunks/provider-renderer.Ds6ktNsn.js");return{default:a}},__vite__mapDeps([6,2,1]))).default});const B=g();k(async()=>{B.value=(await u(async()=>{const{default:a}=await import("./chunks/list-auto-scroll.CCRgzk2q.js");return{default:a}},__vite__mapDeps([7,1,2]))).default});const A=g();k(async()=>{A.value=(await u(async()=>{const{default:a}=await import("./chunks/list-hidden.DaTLJUMy.js");return{default:a}},__vite__mapDeps([8,2,1]))).default});const F=g();k(async()=>{F.value=(await u(async()=>{const{default:a}=await import("./chunks/list-array-content.D_KLLQH2.js");return{default:a}},__vite__mapDeps([9,2,1]))).default});const x=g();k(async()=>{x.value=(await u(async()=>{const{default:a}=await import("./chunks/list-custom-group.Cwq0mi5J.js");return{default:a}},__vite__mapDeps([10,2,1]))).default});const D=g();k(async()=>{D.value=(await u(async()=>{const{default:a}=await import("./chunks/list-consecutive.BAHq6Neb.js");return{default:a}},__vite__mapDeps([11,2,1]))).default});const _=g();k(async()=>{_.value=(await u(async()=>{const{default:a}=await import("./chunks/list.BgbA9NvW.js");return{default:a}},__vite__mapDeps([12,2,1]))).default});const T=g();k(async()=>{T.value=(await u(async()=>{const{default:a}=await import("./chunks/schema-render.C0QskAOK.js");return{default:a}},__vite__mapDeps([13,1,2]))).default});const R=g();k(async()=>{R.value=(await u(async()=>{const{default:a}=await import("./chunks/slots.B3yUMQjN.js");return{default:a}},__vite__mapDeps([14,2,1]))).default});const W=g();k(async()=>{W.value=(await u(async()=>{const{default:a}=await import("./chunks/content-resolver.BXC4_gzE.js");return{default:a}},__vite__mapDeps([15,2,1]))).default});const w=g();k(async()=>{w.value=(await u(async()=>{const{default:a}=await import("./chunks/content-render-mode.otaIJbIz.js");return{default:a}},__vite__mapDeps([16,2,1]))).default});const I=g();k(async()=>{I.value=(await u(async()=>{const{default:a}=await import("./chunks/image.B5rTk0Kn.js");return{default:a}},__vite__mapDeps([17,1,2]))).default});const Z=g();k(async()=>{Z.value=(await u(async()=>{const{default:a}=await import("./chunks/streaming.oUeugR_G.js");return{default:a}},__vite__mapDeps([18,2,1]))).default});const S=g();k(async()=>{S.value=(await u(async()=>{const{default:a}=await import("./chunks/markdown.pftMmKju.js");return{default:a}},__vite__mapDeps([19,2,1]))).default});const G=g();k(async()=>{G.value=(await u(async()=>{const{default:a}=await import("./chunks/loading.DhxNHwRt.js");return{default:a}},__vite__mapDeps([20,1,2]))).default});const P=g();k(async()=>{P.value=(await u(async()=>{const{default:a}=await import("./chunks/shape.CbeBgevW.js");return{default:a}},__vite__mapDeps([21,2,1]))).default});const L=g();k(async()=>{L.value=(await u(async()=>{const{default:a}=await import("./chunks/avatar-and-placement.DkL-Nb6x.js");return{default:a}},__vite__mapDeps([22,2,1]))).default});const n=z(!0),X=g();return k(async()=>{X.value=(await u(async()=>{const{default:a}=await import("./chunks/basic.BrmWc2z_.js");return{default:a}},__vite__mapDeps([23,2,1]))).default}),(a,e)=>{const o=q("ClientOnly");return J(),V("div",null,[e[23]||(e[23]=y('<h1 id="bubble-气泡组件" tabindex="-1">Bubble 气泡组件 <a class="header-anchor" href="#bubble-气泡组件" aria-label="Permalink to &quot;Bubble 气泡组件&quot;">​</a></h1><div class="danger custom-block"><p class="custom-block-title">重大版本升级 v0.4</p><p>Bubble 在 v0.4 进行了重大升级。</p><p><strong>从 v0.3.x 升级？</strong> 请查看 <a href="./../migration/bubble-migration.html">Bubble 迁移指南</a>。</p><p><strong>新项目：</strong> 直接使用下方 v0.4 的 API 和示例即可。</p></div><p>Bubble 气泡组件用于展示消息气泡，支持流式文本、头像、位置、加载中、终止状态、操作按钮等功能。组件采用渲染器架构，支持灵活的内容渲染和自定义扩展。</p><p>主要解决以下问题：</p><ul><li><strong>消息展示</strong>：支持文本、图片、Markdown 等多种内容类型的渲染</li><li><strong>流式输出</strong>：支持流式文本展示，适用于 AI 对话场景</li><li><strong>消息分组</strong>：支持将连续相同角色的消息合并显示</li><li><strong>自定义渲染</strong>：通过渲染器系统支持自定义内容渲染逻辑</li><li><strong>状态管理</strong>：支持消息状态管理，用于存储 UI 相关的数据</li></ul><h2 id="代码示例" tabindex="-1">代码示例 <a class="header-anchor" href="#代码示例" aria-label="Permalink to &quot;代码示例&quot;">​</a></h2><h3 id="基本示例" tabindex="-1">基本示例 <a class="header-anchor" href="#基本示例" aria-label="Permalink to &quot;基本示例&quot;">​</a></h3><p>基本示例。使用 <code>content</code> 属性设置气泡内容，可以使用 css 变量来设置样式，比如：</p><ul><li>气泡背景 <code>--tr-bubble-box-bg</code></li><li>气泡文字大小 <code>--tr-bubble-text-font-size</code></li></ul><blockquote><p>更多 css 变量请参考 <a href="#css-变量">CSS 变量</a></p></blockquote>',10)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{n.value=!1}),vueCode:s(he)},p({_:2},[X.value?{name:"vue",fn:i(()=>[t(s(X))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[24]||(e[24]=l("h3",{id:"头像和位置",tabindex:"-1"},[b("头像和位置 "),l("a",{class:"header-anchor",href:"#头像和位置","aria-label":'Permalink to "头像和位置"'},"​")],-1)),e[25]||(e[25]=l("p",null,[b("通过 "),l("code",null,"avatar"),b(" 设置自定义头像，通过 "),l("code",null,"placement"),b(" 设置位置，提供了 "),l("code",null,"start"),b("、"),l("code",null,"end"),b(" 两个选项")],-1)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[1]||(e[1]=()=>{n.value=!1}),vueCode:s(pe)},p({_:2},[L.value?{name:"vue",fn:i(()=>[t(s(L))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[26]||(e[26]=y('<h3 id="气泡形状" tabindex="-1">气泡形状 <a class="header-anchor" href="#气泡形状" aria-label="Permalink to &quot;气泡形状&quot;">​</a></h3><p>通过 <code>shape</code> 设置气泡形状。目前提供了 <code>rounded</code>、<code>corner</code> 和 <code>none</code> 三个选项。默认为 <code>corner</code>，可以使用 css 变量来设置圆角</p><ul><li>rounded 形状气泡圆角 <code>--tr-bubble-box-shape-rounded-radius</code></li><li>corner 形状气泡圆角 <code>--tr-bubble-box-shape-corner-radius</code>。这个 CSS 变量只会设置 corner 一个角的圆角，另外3个角则使用的 <code>--tr-bubble-box-shape-rounded-radius</code> 的值</li><li>none 形状气泡圆角 <code>--tr-bubble-box-border-radius</code></li></ul>',3)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[2]||(e[2]=()=>{n.value=!1}),vueCode:s(re)},p({_:2},[P.value?{name:"vue",fn:i(()=>[t(s(P))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[27]||(e[27]=l("h3",{id:"加载中",tabindex:"-1"},[b("加载中 "),l("a",{class:"header-anchor",href:"#加载中","aria-label":'Permalink to "加载中"'},"​")],-1)),e[28]||(e[28]=l("p",null,[b("通过 "),l("code",null,"loading"),b(" 设置加载中状态")],-1)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[3]||(e[3]=()=>{n.value=!1}),vueCode:s(de)},p({_:2},[G.value?{name:"vue",fn:i(()=>[t(s(G))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[29]||(e[29]=y(`<h3 id="渲染-markdown" tabindex="-1">渲染 markdown <a class="header-anchor" href="#渲染-markdown" aria-label="Permalink to &quot;渲染 markdown&quot;">​</a></h3><p>Bubble 组件提供了 <code>markdown</code> 渲染器，可以渲染 markdown 内容。需要安装 <code>markdown-it</code> 和 <code>dompurify</code> 依赖</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># npm</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">pnpm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> add</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> markdown-it</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> dompurify</span></span></code></pre></div>`,3)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[4]||(e[4]=()=>{n.value=!1}),vueCode:s(oe)},p({_:2},[S.value?{name:"vue",fn:i(()=>[t(s(S))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[30]||(e[30]=l("h3",{id:"流式文本",tabindex:"-1"},[b("流式文本 "),l("a",{class:"header-anchor",href:"#流式文本","aria-label":'Permalink to "流式文本"'},"​")],-1)),e[31]||(e[31]=l("p",null,[l("code",null,"content"),b(" 属性是响应式的，动态设置 "),l("code",null,"content"),b(" 即可实现流式文本")],-1)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[5]||(e[5]=()=>{n.value=!1}),vueCode:s(le)},p({_:2},[Z.value?{name:"vue",fn:i(()=>[t(s(Z))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[32]||(e[32]=y('<h3 id="图片渲染" tabindex="-1">图片渲染 <a class="header-anchor" href="#图片渲染" aria-label="Permalink to &quot;图片渲染&quot;">​</a></h3><p>Bubble 组件支持渲染图片内容。当 <code>content</code> 为数组且包含 <code>type: &#39;image_url&#39;</code> 的内容项时，会自动使用 Image 渲染器。</p><p>图文混合时，可以通过 <code>contentRenderMode</code> 控制渲染方式：</p><ul><li><code>&#39;single&#39;</code> 模式：文本和图片在同一个 box 中渲染</li><li><code>&#39;split&#39;</code> 模式：每个内容项（文本或图片）单独一个 box</li></ul>',4)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[6]||(e[6]=()=>{n.value=!1}),vueCode:s(ae)},p({_:2},[I.value?{name:"vue",fn:i(()=>[t(s(I))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[33]||(e[33]=y('<h3 id="内容渲染模式" tabindex="-1">内容渲染模式 <a class="header-anchor" href="#内容渲染模式" aria-label="Permalink to &quot;内容渲染模式&quot;">​</a></h3><p>通过 <code>contentRenderMode</code> 设置内容渲染模式：</p><ul><li><code>&#39;single&#39;</code>（默认）：所有内容在一个 box 中渲染</li><li><code>&#39;split&#39;</code>：当 <code>content</code> 为数组时，每个内容项单独一个 box</li></ul>',3)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[7]||(e[7]=()=>{n.value=!1}),vueCode:s(ie)},p({_:2},[w.value?{name:"vue",fn:i(()=>[t(s(w))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[34]||(e[34]=y('<blockquote><p><strong>注意</strong>：<code>&#39;single&#39;</code> 模式会将所有内容在一个 box 中渲染（默认）。<code>&#39;split&#39;</code> 模式会在 <code>content</code> 为数组时，将每个内容项单独一个 box 渲染。</p></blockquote><h3 id="内容解析器" tabindex="-1">内容解析器 <a class="header-anchor" href="#内容解析器" aria-label="Permalink to &quot;内容解析器&quot;">​</a></h3><p>通过 <code>contentResolver</code> 可以自定义内容解析逻辑，用于从消息的其他字段提取内容。</p>',3)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[8]||(e[8]=()=>{n.value=!1}),vueCode:s(ne)},p({_:2},[W.value?{name:"vue",fn:i(()=>[t(s(W))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[35]||(e[35]=y('<blockquote><p><strong>注意</strong>：默认情况下，组件使用 <code>message.content</code> 作为内容。如果需要自定义内容解析逻辑（例如从其他字段提取内容），可以通过 <code>contentResolver</code> 属性传入自定义函数。</p></blockquote><h3 id="插槽" tabindex="-1">插槽 <a class="header-anchor" href="#插槽" aria-label="Permalink to &quot;插槽&quot;">​</a></h3><p>气泡组件提供了多个插槽，分别是 <code>prefix</code> 插槽, <code>suffix</code> 插槽、<code>content-footer</code> 插槽 和 <code>after</code> 插槽</p>',3)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[9]||(e[9]=()=>{n.value=!1}),vueCode:s(se)},p({_:2},[R.value?{name:"vue",fn:i(()=>[t(s(R))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[36]||(e[36]=l("h3",{id:"schema-卡片渲染",tabindex:"-1"},[b("schema 卡片渲染 "),l("a",{class:"header-anchor",href:"#schema-卡片渲染","aria-label":'Permalink to "schema 卡片渲染"'},"​")],-1)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%22schema-render.vue%22%3A%7B%22filename%22%3A%22..%2F..%2Fdemos%2Fbubble%2Fschema-render.vue%22%2C%22code%22%3A%22%3Ctemplate%3E%5Cn%20%20%3Cdiv%20style%3D%5C%22display%3A%20flex%3B%20flex-direction%3A%20column%3B%20gap%3A%2016px%5C%22%3E%5Cn%20%20%20%20%3Cp%20style%3D%5C%22font-size%3A%2012px%3B%20color%3A%20%23666%3B%20margin%3A%200%5C%22%3E%E4%BD%BF%E7%94%A8%20Markdown%20%E6%B8%B2%E6%9F%93%E5%99%A8%E6%B8%B2%E6%9F%93%E8%BF%90%E8%A1%8C%E6%97%B6%E7%BB%84%E4%BB%B6%EF%BC%88WebComponent%EF%BC%89%3C%2Fp%3E%5Cn%20%20%20%20%3Ctr-bubble-provider%20%3Astore%3D%5C%22bubbleStore%5C%22%3E%5Cn%20%20%20%20%20%20%3Ctr-bubble%5Cn%20%20%20%20%20%20%20%20%3Aavatar%3D%5C%22aiAvatar%5C%22%5Cn%20%20%20%20%20%20%20%20%3Acontent%3D%5C%22mdContent%5C%22%5Cn%20%20%20%20%20%20%20%20%3Afallback-content-renderer%3D%5C%22BubbleRenderers.Markdown%5C%22%5Cn%20%20%20%20%20%20%3E%3C%2Ftr-bubble%3E%5Cn%20%20%20%20%3C%2Ftr-bubble-provider%3E%5Cn%20%20%3C%2Fdiv%3E%5Cn%3C%2Ftemplate%3E%5Cn%5Cn%3Cscript%20setup%20lang%3D%5C%22ts%5C%22%3E%5Cnimport%20%7B%20BubbleRenderers%2C%20TrBubble%2C%20TrBubbleProvider%20%7D%20from%20'%40opentiny%2Ftiny-robot'%5Cnimport%20%7B%20IconAi%20%7D%20from%20'%40opentiny%2Ftiny-robot-svgs'%5Cnimport%20%7B%20defineCustomElement%2C%20h%2C%20reactive%2C%20ref%20%7D%20from%20'vue'%5Cnimport%20SchemaCard%20from%20'.%2Fschema-card.ce.vue'%5Cn%5Cnconst%20aiAvatar%20%3D%20h(IconAi%2C%20%7B%20style%3A%20%7B%20fontSize%3A%20'32px'%20%7D%20%7D)%5Cn%5Cnconst%20bubbleStore%20%3D%20reactive(%7B%5Cn%20%20mdConfig%3A%20%7B%20html%3A%20true%20%7D%2C%5Cn%20%20dompurifyConfig%3A%20%7B%20ADD_TAGS%3A%20%5B'schema-card'%5D%2C%20ADD_ATTR%3A%20%5B'schema'%5D%20%7D%2C%5Cn%7D)%5Cn%5Cnconst%20schemaObj%20%3D%20ref(%5Cn%20%20JSON.stringify(%7B%5Cn%20%20%20%20componentName%3A%20'Page'%2C%5Cn%20%20%20%20children%3A%20%5B%5Cn%20%20%20%20%20%20%7B%20componentName%3A%20'Text'%2C%20props%3A%20%7B%20text%3A%20'%E8%BF%90%E8%A1%8C%E6%97%B6%E6%B8%B2%E6%9F%93%E5%99%A8%E6%96%87%E6%9C%AC'%20%7D%20%7D%2C%5Cn%20%20%20%20%20%20%7B%20componentName%3A%20'Button'%2C%20props%3A%20%7B%20text%3A%20'%E8%BF%90%E8%A1%8C%E6%97%B6%E6%B8%B2%E6%9F%93%E5%99%A8%E6%8C%89%E9%92%AE'%20%7D%20%7D%2C%5Cn%20%20%20%20%5D%2C%5Cn%20%20%7D)%2C%5Cn)%5Cn%5Cn%2F%2F%20%E6%B3%A8%E5%86%8C%E8%87%AA%E5%AE%9A%E4%B9%89%E5%85%83%E7%B4%A0%5Cnif%20(!customElements.get('schema-card'))%20%7B%5Cn%20%20const%20CardElement%20%3D%20defineCustomElement(SchemaCard)%5Cn%20%20customElements.define('schema-card'%2C%20CardElement)%5Cn%7D%5Cn%5Cnconst%20mdContent%20%3D%20%60%23%20Markdown%20%E6%A0%87%E9%A2%98%5Cn%5Cn**%E5%8A%A0%E7%B2%97%E6%96%87%E6%9C%AC**%5Cn%5Cn%3Cschema-card%20schema%3D'%24%7BschemaObj.value%7D'%3E%3C%2Fschema-card%3E%5Cn%60%5Cn%3C%2Fscript%3E%5Cn%22%7D%2C%22schema-card.ce.vue%22%3A%7B%22filename%22%3A%22..%2F..%2Fdemos%2Fbubble%2Fschema-card.ce.vue%22%2C%22code%22%3A%22%3Ctemplate%3E%5Cn%20%20%3Cschema-renderer%20%3Aschema%3D%5C%22schemaObj%5C%22%3E%3C%2Fschema-renderer%3E%5Cn%3C%2Ftemplate%3E%5Cn%5Cn%3Cscript%20setup%20lang%3D%5C%22ts%5C%22%3E%5Cnimport%20SchemaRenderer%20from%20'%40opentiny%2Ftiny-schema-renderer'%5Cnimport%20%7B%20computed%20%7D%20from%20'vue'%5Cn%5Cnconst%20props%20%3D%20defineProps(%7B%5Cn%20%20schema%3A%20%7B%5Cn%20%20%20%20type%3A%20String%2C%5Cn%20%20%20%20required%3A%20true%2C%5Cn%20%20%7D%2C%5Cn%7D)%5Cn%5Cnconst%20schemaObj%20%3D%20computed(()%20%3D%3E%20%7B%5Cn%20%20return%20JSON.parse(props.schema)%5Cn%7D)%5Cn%3C%2Fscript%3E%5Cn%3Cstyle%3E%5Cn%40import%20url('%40opentiny%2Fvue-theme%2Findex.css')%3B%5Cn%3C%2Fstyle%3E%5Cn%22%7D%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[10]||(e[10]=()=>{n.value=!1}),vueCode:s(te)},p({_:2},[T.value?{name:"vue",fn:i(()=>[t(s(T))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[37]||(e[37]=l("h3",{id:"列表",tabindex:"-1"},[b("列表 "),l("a",{class:"header-anchor",href:"#列表","aria-label":'Permalink to "列表"'},"​")],-1)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[11]||(e[11]=()=>{n.value=!1}),vueCode:s(ee)},p({_:2},[_.value?{name:"vue",fn:i(()=>[t(s(_))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[38]||(e[38]=l("h3",{id:"分组策略",tabindex:"-1"},[b("分组策略 "),l("a",{class:"header-anchor",href:"#分组策略","aria-label":'Permalink to "分组策略"'},"​")],-1)),e[39]||(e[39]=l("p",null,"BubbleList 支持多种分组策略：",-1)),e[40]||(e[40]=l("p",null,[l("strong",null,"连续分组（consecutive）")],-1)),e[41]||(e[41]=l("p",null,"连续相同角色的消息会被合并为一组。",-1)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[12]||(e[12]=()=>{n.value=!1}),vueCode:s(K)},p({_:2},[D.value?{name:"vue",fn:i(()=>[t(s(D))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[42]||(e[42]=l("p",null,[l("strong",null,"自定义分组函数")],-1)),e[43]||(e[43]=l("p",null,"可以通过自定义函数实现更灵活的分组逻辑。",-1)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[13]||(e[13]=()=>{n.value=!1}),vueCode:s($)},p({_:2},[x.value?{name:"vue",fn:i(()=>[t(s(x))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[44]||(e[44]=l("p",null,[l("strong",null,"数组内容的分组")],-1)),e[45]||(e[45]=l("p",null,[b("当 "),l("code",null,"message.role === 'user'"),b(" 且 "),l("code",null,"content"),b(" 为数组时，该消息会被单独作为一个独立分组（密封），后续的消息（即使角色相同）也不会被添加到这个分组中。")],-1)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[14]||(e[14]=()=>{n.value=!1}),vueCode:s(H)},p({_:2},[F.value?{name:"vue",fn:i(()=>[t(s(F))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[46]||(e[46]=y('<blockquote><p><strong>注意</strong>：分组策略的特殊处理规则：</p><ul><li>当 <code>message.role === &#39;user&#39;</code> 且 <code>content</code> 为数组时，该消息会被单独作为一个独立分组（密封），后续的消息（即使角色相同）也不会被添加到这个分组中</li><li><code>hidden</code> 消息的分组规则：连续的 <code>hidden</code> 消息可以同一组</li></ul></blockquote><h3 id="隐藏角色" tabindex="-1">隐藏角色 <a class="header-anchor" href="#隐藏角色" aria-label="Permalink to &quot;隐藏角色&quot;">​</a></h3><p>角色配置中使用 <code>hidden</code> 来隐藏这个角色的所有消息</p>',3)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[15]||(e[15]=()=>{n.value=!1}),vueCode:s(Q)},p({_:2},[A.value?{name:"vue",fn:i(()=>[t(s(A))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[47]||(e[47]=l("h3",{id:"自动滚动",tabindex:"-1"},[b("自动滚动 "),l("a",{class:"header-anchor",href:"#自动滚动","aria-label":'Permalink to "自动滚动"'},"​")],-1)),e[48]||(e[48]=l("p",null,[b("通过 "),l("code",null,"autoScroll"),b(" 属性启用自动滚动功能。当新消息添加时，如果滚动容器接近底部，会自动滚动到底部。")],-1)),d(t(s(h),null,null,512),[[r,n.value]]),t(o,null,{default:i(()=>[t(s(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[16]||(e[16]=()=>{n.value=!1}),vueCode:s(O)},p({_:2},[B.value?{name:"vue",fn:i(()=>[t(s(B))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[49]||(e[49]=y(`<blockquote><p><strong>注意</strong>：<code>autoScroll</code> 功能有两种触发机制：</p><ol><li><strong>常规自动滚动</strong>：当消息内容变化时（如消息数量、内容、推理内容），如果满足以下条件会自动滚动： <ul><li>BubbleList 必须是可滚动容器（<code>scrollHeight &gt; clientHeight</code>）</li><li>滚动容器需要接近底部</li></ul></li><li><strong>用户消息特殊处理</strong>：当最后一条消息的 <code>role</code> 为 <code>&#39;user&#39;</code> 时，会立即使用平滑滚动（<code>smooth</code>）滚动到底部，无需满足上述条件。这确保了用户发送消息后能立即看到自己发送的内容。</li></ol></blockquote><h3 id="自定义渲染器" tabindex="-1">自定义渲染器 <a class="header-anchor" href="#自定义渲染器" aria-label="Permalink to &quot;自定义渲染器&quot;">​</a></h3><p>Bubble 组件采用渲染器架构，支持灵活的内容渲染和自定义扩展。渲染器系统分为两种类型：</p><ul><li><strong>Box 渲染器</strong>：用于渲染消息的外层容器（box），控制气泡的样式和布局</li><li><strong>Content 渲染器</strong>：用于渲染消息的具体内容，如文本、图片、Markdown 等</li></ul><h4 id="渲染器匹配机制" tabindex="-1">渲染器匹配机制 <a class="header-anchor" href="#渲染器匹配机制" aria-label="Permalink to &quot;渲染器匹配机制&quot;">​</a></h4><p>渲染器通过匹配规则来选择，匹配过程如下：</p><ol><li>按照优先级排序所有匹配规则（<code>priority</code> 值越小优先级越高）</li><li>依次执行每个规则的 <code>find</code> 函数，找到第一个返回 <code>true</code> 的规则</li><li>使用该规则对应的渲染器</li><li>如果没有匹配到任何规则，使用 fallback 渲染器</li></ol><h4 id="渲染器配置层级" tabindex="-1">渲染器配置层级 <a class="header-anchor" href="#渲染器配置层级" aria-label="Permalink to &quot;渲染器配置层级&quot;">​</a></h4><p>渲染器配置支持三个层级，优先级从高到低：</p><ol><li><strong>Prop 级别</strong>：通过 <code>Bubble</code>、<code>BubbleList</code> 的 <code>fallback-box-renderer</code> 和 <code>fallback-content-renderer</code> 属性配置，只对当前组件生效</li><li><strong>Provider 级别</strong>：通过 <code>BubbleProvider</code> 的 <code>box-renderer-matches</code>、<code>content-renderer-matches</code> 和 fallback 属性配置，在整个组件树中生效</li><li><strong>Default 级别</strong>：内置的默认渲染器和匹配规则</li></ol><p><strong>设置 Fallback 渲染器</strong></p><p>当无法匹配到合适的渲染器时，会使用 fallback 渲染器。上面的<a href="#渲染-markdown">渲染 markdown 示例</a>中，就是通过 <code>fallback-content-renderer</code> 属性设置的 <code>BubbleRenderers.Markdown</code> 渲染器。</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">template</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
